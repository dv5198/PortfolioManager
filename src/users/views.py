...
class UserDetailView(DetailView):
    ...
    def get_context_data(self, **kwargs):
        id_ = self.kwargs.get("id")
        data = super().get_context_data(**kwargs) #user record
        
        start_day = get_start_day_for_user(id_)  #Today's date
        ...
        for yr in range(start_day.year, curr_yr+1):
            ...
            # Fetch Contrib and deduct value based on PPf
            ...
            # Fetch Contrib and deduct value based on R401K
            ...
            # Fetch Contrib and deduct value based on Rsu
            ...
            # Fetch Contrib and deduct value based on Insurance
            ...
            # Fetch Contrib and deduct value based on Gold
            ...
            # Fetch Contrib and deduct value based on Bank Details
            ...
            # Fetch Contrib and deduct value based on Epfs
            ...
            # Fetch Contrib and deduct value based on Ssy
            ...
            # Fetch Contrib and deduct value based on MFs
            ...
            # Fetch Contrib and deduct value based on ESPP
            ...
            # Fetch Contrib and deduct value based on FDs
            ...
            # Fetch Contrib and deduct value based on Shares Values
...
def add_user(request):
    ...
    if request.method == 'POST':
        ...
        total_networth=request.POST['networth']
        User.objects.create(name=name, dob=dob, notes=notes, email=email, short_name=short_name,total_networth=total_networth)
