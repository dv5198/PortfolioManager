    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alert_type', models.CharField(choices=[('Application', 'Application'), ('Action', 'Action'), ('Notification', 'Notification'), ('Marketing', 'Marketing')], default='Notification', max_length=10)),
            ],
        ),
    ]
