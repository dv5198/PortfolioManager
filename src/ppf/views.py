...
class PpfListView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        for ppf_obj in Ppf.objects.all():
            ...
            data['total_roi']+=ppf_details['roi']
            data['total_principal']+=ppf_details['principal']
            data['total_interest']+=ppf_details['interest']
            data['total_amount']+=ppf_details['total']
            data['total_ppf']+=Ppf.objects.count()
